...
const HOTSPOTS_DATA = [
  { id:"H1", location:"park", phase:"morgen", position:{x:0.38,y:0.62}, label:"Aludose im Gras", description:"Eine leere Aludose liegt im Gras neben einer Bank. Eine Recyclingstation ist 20 Meter entfernt.", type:"dual", branching:"static", available_if:{flags:[],not_flags:[]}, option_a:{text:"Die Dose aufheben und in den Aluminium-Container werfen.",points:50,sets_flag:"picked_up_can"}, option_b:{text:"Ach, hat eh schon Müll hier. Meinen Becher stelle ich auch gleich dazu.",points:-100,sets_flag:"added_to_litter"} },
  { id:"H2", location:"park", phase:"morgen", position:{x:0.60,y:0.55}, label:"Verletzte:r Jogger:in am Wegrand", description:"Eine Person ist gestolpert und sitzt am Boden, sie hält sich den Knöchel.", type:"positive_only", branching:"unlock", available_if:{flags:[],not_flags:[]}, option_a:{text:"Anhalten, fragen ob alles ok ist, Notfallnummer anbieten.",points:100,sets_flag:"helped_jogger"} },
  { id:"H19", location:"park", phase:"morgen", position:{x:0.22,y:0.45}, label:"Unverschlossenes E-Bike am Baum", description:"Ein schönes E-Bike lehnt ohne Schloss an einem Baum. Niemand ist in der Nähe.", type:"negative_only", branching:"static", available_if:{flags:[],not_flags:[]}, option_a:{text:"Wegfahren, das gehört jetzt dir.",points:-200,sets_flag:"stole_bike"} },
