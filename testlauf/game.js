...
const HOTSPOTS_DATA = [
  ...
  { id:"H19", location:"park", phase:"morgen", position:{x:0.17,y:0.40}, label:"Unverschlossenes E-Bike am Baum", description:"Ein schönes E-Bike lehnt ohne Schloss an einem Baum. Niemand ist in der Nähe.", type:"negative_only", branching:"static", available_if:{flags:[],not_flags:[]}, option_a:{text:"Wegfahren, das gehört jetzt dir.",points:-200,sets_flag:"stole_bike"} },
